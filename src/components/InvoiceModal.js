...
//  render() {
 export default function InvoiceModal({showModal, closeModal, info, total, items, subTotal, taxAmount, discountAmount}) {
    return(
      <div>
          ...
          <div id="invoiceCapture">
            <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
              ...
              <div className="text-end ms-4">
                ...
                <h5 className="fw-bold text-secondary"> {info.currency} {total}</h5>
              </div>
            </div>
            <div className="p-4">
              <Row className="mb-4">
              ...
              <Table>
                <tbody>
                  ...
                  <tr className="text-end">
                    ...
                    <td className="text-end" style={{width: '100px'}}>{info.currency} {subTotal}</td>
                  </tr>
                  {taxAmount !== 0.00 &&
                    <tr className="text-end">
                      <td></td>
                      <td className="fw-bold" style={{width: '100px'}}>TAX</td>
                      <td className="text-end" style={{width: '100px'}}>{info.currency} {taxAmount}</td>
                    </tr>
                  }
                  {discountAmount !== 0.00 &&
                    <tr className="text-end">
                      ...
                      <td className="text-end" style={{width: '100px'}}>{info.currency} {discountAmount}</td>
                    </tr>
                  }
                  <tr className="text-end">
                    <td></td>
                    <td className="fw-bold" style={{width: '100px'}}>TOTAL</td>
                    <td className="text-end" style={{width: '100px'}}>{info.currency} {total}</td>
                  </tr>
                </tbody>
              </Table>
              {info.notes &&
